...
export class NSMarqueeLabel extends TextBase implements LabelDefinition {
  nativeViewProtected: MarqueeLabel;
  private _fixedSize: FixedSize = FixedSize.NONE;
  ...
  public onMeasure(widthMeasureSpec: number, heightMeasureSpec: number): void {
    ...
    if (nativeView) {
      ...
      this._fixedSize =
        (widthMode === layout.EXACTLY ? FixedSize.WIDTH : FixedSize.NONE) |
      ...
      if (this.textWrap) {
        ...
        nativeSize = this._measureNativeView(
          width,
          widthMode,
          height,
          heightMode
        ...
        nativeSize = layout.measureNativeView(
          nativeView,
          width,
          widthMode,
          height,
  ...
  private _measureNativeView(
    ...
    const view = <MarqueeLabel>this.nativeTextViewProtected;
  ...
  _redrawNativeBackground(value: UIColor | Background): void {
    if (value instanceof Background) {
      // @ts-ignore
      this.ios.createBackgroundUIColor(
        this,
        (color: UIColor) => {
